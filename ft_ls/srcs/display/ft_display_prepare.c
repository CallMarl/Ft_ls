...
/*   Updated: 2018/05/18 14:08:53 by pprikazs         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void
	ft_display_prepare_aux(t_disp *disp, t_file *file)
{
	int					tmp;
...
extern void
	ft_display_prepare(t_buff *buff, t_disp *disp, int opt_a, size_t *block)
{
	size_t				i;
	t_file				*file;
